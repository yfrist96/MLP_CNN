...
batch_size = 32
path = 'C:/Users/Yehuda Frist/ML Methods/exercise_4/whichfaceisreal' # For example '/cs/usr/username/whichfaceisreal/'
...
accuracy = xgb_model.score(test_data, test_labels)
